...
export default function About() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-4 mb-10">
      <h1 className="text-2xl font-semibold text-gray-800 text-center border-b-2 border-gray-800 pb-1">
        About Me
      </h1>
      {/* ✅ Brief Introduction */}
      <section className="mt-12 flex flex-col md:flex-row items-center gap-8 slide-in">
        <div className="w-full md:w-1/3 relative">
          <div
            className="relative w-44 h-44 mx-auto rounded-full shadow-lg transition-all"
        ...
        <div className="w-full p-5 rounded-md bg-tertiarybg md:w-2/3 fade-in">
          <h2 className="text-xl text-gray-800">Brief Introduction</h2>
      ...
      <section className="mt-12 flex flex-col md:flex-row items-center gap-8  ">
        <div className="w-full md:w-2/3 bg-tertiarybg p-5 rounded-md">
          <h2 className="text-xl font-semibold text-gray-800">What I Do</h2>
      ...
      <section className="mt-20">
        <h2 className="text-xl font-semibold text-gray-800 text-center fade-in">
          Skills & Technologies
        </h2>
        <div className="overflow-hidden mt-6 relative h-12">
      ...
      <section className="mt-16 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-2/3 bg-tertiarybg rounded-md p-5">
